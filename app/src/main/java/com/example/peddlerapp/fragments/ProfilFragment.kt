...
class ProfilFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        paiement_btn.setOnClickListener {
            val intent = Intent(root.context, PaimentActivity::class.java)
            startActivity(intent)
        }
        ...
        Picasso.get().load("http://192.168.1.11:3000/img/${UserSession.image}").into(picture)
        ...
        Picasso.get().load("http://192.168.1.11:3000/img/${UserSession.image}").into(full_screen_picture_iv)
