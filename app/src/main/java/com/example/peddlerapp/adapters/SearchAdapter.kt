package com.example.peddlerapp.adapters
...
import com.example.peddlerapp.DetailProduitActivity
...
class SearchAdapter(private val dataSet: ArrayList<Produit>, private val mContext: Context) :
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, position: Int) {
        ...
        Picasso.get().load("http://192.168.1.11:3000/img/${dataSet[position].image}").into(viewHolder.imgView);
